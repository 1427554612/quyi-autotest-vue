                    ...
                    <pane :size="paneSize" min-size="20" sty>
                        <div id="left">
                            ...
                            <el-card id="charts1-card" style="height:800px">
                                <div style="width: 97%;margin-top: 10px;margin-left: 10px;">
                                    <el-table :data="resultInfoList" border style="width: 100%;" max-height="600" >
...
export default {
  ...
  methods: {
    ...
    // 回显结果列表
    callbackShowResultInfoList(current){
        this.current = current
        testResultApi.findAllResultInfo(this.resultId,this.current,this.size).then(response=>{
